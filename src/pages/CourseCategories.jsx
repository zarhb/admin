...
const {t}=useTranslation();
 ...
 const handleDeleteCategoury =async ()=>{
  ...
  const response =  httpInterseptedService.delete(`/CourseCategory/${selectedCategory}`);
  ...
  return (
    ...
    <Modal isOpen={showDeleteModal} open={setShowDeleteModal} title={"حذف"} body={"آیا از حذف این دسته اطمینان دارید؟"}> 
     ...
     <button type="button" className="btn btn-primary fw-bolder" onClick={handleDeleteCategoury}> حذف</button>
    </Modal>
    </>
  );
};
